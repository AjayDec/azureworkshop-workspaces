...
module "networking" {
  source  = "app.terraform.io/tryterraforment/networking/azurerm"
  version = "0.0.1"
...
module "webserver" {
  source  = "app.terraform.io/tryterraforment/webserver/azurerm"
  version = "0.0.1"
...
module "appserver" {
  source  = "app.terraform.io/tryterraforment/appserver/azurerm"
  version = "0.0.1"
...
module "dataserver" {
  source  = "app.terraform.io/tryterraforment/dataserver/azurerm"
  version = "0.0.1"
